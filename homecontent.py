...
class HomeContent(tk.Frame):
    def __init__(self, master):
        ...
        self.view_camera_label.grid(row=0, column=3, sticky="w", padx=0, pady=5)
        ...
        self.camera_dropdown.grid(row=0, column=4, sticky="w", padx=0, pady=5)
        ...
        self.remaining_space_box.place(width=initial_width, height=initial_height, x=100, y=80, anchor="nw")  # Adjust the coordinates as needed
