...
from face_recognitions.arcface.utils import compare_encodings, read_features
...
# Add a global variable to signal threads to exit
exit_threads = False
...
def tracking(detector, args):
    ...
    Args:
        ...
        args (dict): Tracking configuration parameters.
    """
    global exit_threads  # Use the global variable
    ...
    while True:
        ...
        ch = cv2.waitKey(1) & 0xFF  # Ensure compatibility with 64-bit systems
        if ch == 27 or ch == ord("q") or ch == ord("Q") or exit_threads:
            break
