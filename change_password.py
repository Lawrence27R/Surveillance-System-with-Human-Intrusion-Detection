...
class ChangePasswordWindow(tk.Toplevel):
    ...
    def __init__(self, master, change_password_callback):
        ...
        self.old_password_label = tk.Label(self, text="Old Password: ", font=('Century Gothic', 12))
        self.old_password_label.pack()

        self.old_password_entry = Entry(self, show="*", font=('Century Gothic', 12))
        self.old_password_entry.pack()

        self.new_password_label = tk.Label(self, text="New Password: ", font=('Century Gothic', 12))
        self.new_password_label.pack()

        self.new_password_entry = Entry(self, show="*", font=('Century Gothic', 12))
        self.new_password_entry.pack()

        self.confirm_new_password_label = tk.Label(self, text="Confirm New Password: ", font=('Century Gothic', 12))
